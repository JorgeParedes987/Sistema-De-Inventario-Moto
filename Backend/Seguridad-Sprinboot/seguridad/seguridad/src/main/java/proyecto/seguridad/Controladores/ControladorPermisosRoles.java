package proyecto.seguridad.Controladores;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.*;
import proyecto.seguridad.Modelos.Permiso;
import proyecto.seguridad.Modelos.PermisosRoles;
import proyecto.seguridad.Modelos.Rol;
import proyecto.seguridad.Repositorios.RepositorioPermiso;
import proyecto.seguridad.Repositorios.RepositorioPermisosRoles;
import proyecto.seguridad.Repositorios.RepositorioRol;
...
public class ControladorPermisosRoles {
    ...
    public PermisosRoles getPermiso(@PathVariable String id_rol,  @RequestBody Permiso infoPermiso){  Permiso elPermiso=this.miRepositorioPermiso
            .getPermiso(infoPermiso.getUrl(),
                    infoPermiso.getMetodo());
        Rol elRol=this.miRepositorioRol.findById(id_rol).get();  if (elPermiso!=null && elRol!=null){
            return
